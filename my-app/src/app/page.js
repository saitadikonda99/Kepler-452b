...
const page = () => {
  ...
  // TODO: Remove this comments for useEffect
  // useEffect(() => {
        ...
        <div className="three">
          <div className="three-in">
            ...
            <div className="three-two">
              <div className="three-two-in">
                <p>
                  ...
                  postulates, and artistic assertions, creating an environment
            ...
            <div className="three-three">
              ...
              <div className="three-three-two"></div>
            </div>
            <div className="three-four">
              <div className="three-four-in"></div>
            </div>
          </div>
        </div>
              ...
              <div className="five-in-one-card">
                <div className="five-in-one-card-in">
                  ...
                  <div className="five-in-one-card-in-two">
                    <h2>Technology</h2>
                    <p>
                      Explore cutting-edge tech trends and hands-on projects,
                      from coding to robotics, in our vibrant tech enthusiast
                      community.
                    </p>
        ...
        <div className="nine">
          <div className="nine-in">
            <div className="nine-one">
              <h1>
                Experience the power of community. Join us today and be a part
              ...
              <div className="Eleven-one-in">
                ...
                <div className="Social">
                  <div className="Social-in">
                    ...
                    <div className="Social-four">
                      <Link href="https://www.instagram.com/klu_sac/">
                        Follow
                      </Link>
                    </div>
                  </div>
                ...
                <div className="thirteen-box-in">
                  ...
                  <div className="thirteen-box-in-one">
                    <div className="thirteen-box-in-one-in">
                      <Link href="/" className="thirteen-box-in-one-in-link">
                        Aero Electric Club
                      </Link>
                      <Link href="/" className="thirteen-box-in-one-in-link">
                        Agriculture Club
